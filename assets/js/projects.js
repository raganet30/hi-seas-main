...
const projects = [
  {
    ...
    +".\nHiTok fosters engagement through messaging, voice and video calls, and social features such as people nearby and moments while offering integrated e-wallet and payment services. Future upgrades will expand into microloans, online shopping, and ride-hailing, creating a broader ecosystem of opportunity. ",
    images: [
  ...
  },
  {
    ...
    description: "The Barangay Broadband Project (BBP) is a flagship initiative of Hi-Seas Philippines, developed in support of the government’s National Broadband Plan (NBP) to expand digital access nationwide. After two years of research and system development, Hi-Seas introduced a sustainable solution to bring reliable internet connectivity to remote and underserved communities."
      + "\nBBP integrates two core innovations: HiTok, an all-in-one messaging and digital services platform, and HiWiFi, a barangay-wide network that allows seamless, one-click internet access. Through this system, residents benefit from daily free internet access, lifetime free use of HiTok messaging, and unlimited free connectivity for schools and Barangay Halls. To ensure reliability in areas prone to power outages, solar-powered storage systems were also deployed."
...
function openProjectModal(projectId) {
  ...
  // Refactored line to correctly display newlines in HTML
  document.getElementById('modal-project-description').innerHTML = currentProject.description.replace(/\n/g, '<br>');
